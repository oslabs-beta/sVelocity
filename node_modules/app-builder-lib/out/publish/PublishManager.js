...
const BintrayPublisher_1 = require("./BintrayPublisher");
...
class PublishManager {
    ...
    scheduleUpload(publishConfig, event, appInfo) {
        ...
        if (this.publishOptions.publish === "onTagOrDraft" && electron_publish_1.getCiTag() == null && !(providerName === "GitHub" || providerName === "Bintray")) {
