...
class MsiTarget extends core_1.Target {
    ...
    async build(appOutDir, arch) {
        ...
        if (commonOptions.isAssisted) {
            ...
            builder_util_1.log.warn(`MSI DOESN'T SUPPORT assisted installer. Please use NSIS instead.`);
        }
        ...
        if (uiFile !== null) {
            await promises_1.writeFile(uiFile, await promises_1.readFile(path.join(pathManager_1.getTemplatePath("msi"), ASSISTED_UI_FILE_NAME), "utf8"));
    ...
    async writeManifest(appOutDir, arch, commonOptions) {
        ...
        return (await projectTemplate.value)({
            ...
            upgradeCode: (options.upgradeCode || builder_util_runtime_1.UUID.v5(appInfo.id, ELECTRON_BUILDER_UPGRADE_CODE_NS_UUID)).toUpperCase(),
            ...
            installationDirectoryWixName: targetUtil_1.getWindowsInstallationDirName(appInfo, commonOptions.isPerMachine === true),
            dirs,
            files,
        });
    }
